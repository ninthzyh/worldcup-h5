    ...
    <div class="content">
      <div class="home-screen">
        <div class="screen-label">
          ...
          <div class="flag">
            <national-flag :width="`${$vw(28)}`" :height="`${$vw(28)}`" :margin="`0 ${$vw(12)} 0 0`"
              :img="bannerData&&bannerData.homeFlag" />
      ...
      <div class="today-schedule">
        <div class="title"><span>{{$lang.home.todayMatches}}</span><span class="check-all"
            @click="jumpTo">{{$lang.home.seeAll}}</span></div>
